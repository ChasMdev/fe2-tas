        ...
        <frame Key={"ControlButtons"}
            ...
            <textbutton Key={"LoadTasButton"}
                ...
                <uistroke ApplyStrokeMode={"Border"}
                          Thickness={2}
                          Color={Color3.fromHex("#22252D")}/>
                <textlabel Text={"Load TAS"}
                           AnchorPoint={new Vector2(0,0.5)}
                           BackgroundTransparency={1}
                           Font={"GothamBold"}
                           TextSize={16}
