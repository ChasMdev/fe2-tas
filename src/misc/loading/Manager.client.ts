...
for (const [i,assetToLoad] of pairs(assets)) {
    ...
    (ui.WaitForChild("LoadingBarWrapper").WaitForChild("LoadingBar") as Frame).TweenSize(new UDim2(percentage/100, 0, 1, 0), "Out", "Quint", 0.2, true)
}
...
ui.TweenPosition(new UDim2(0.5,0,1.5,0), "In", "Quint", 0.4, false, () => {BackgroundBlur.Destroy()});
